...
export const links = [
  ...
  <NavLink className='tabs-bar__link primary' to='timelines/direct' data-preview-title-id='column.direct' data-preview-icon='envelope' ><i className='fa fa-fw fa-envelope' /><FormattedMessage id='tabs_bar.direct' defaultMessage='Direct Messages' /></NavLink>,
